...
import java.io.*;
import java.util.*;
public class JavaRand extends java.util.Random {

  public JavaRand (int seed) {
    super(seed);
  }
  ...
  public double ran1(){ return ((double)Math.random()*32767 / ((double)(32767)+(double)(1)));}
  public double randVal(double low, double high){return (float)(ran1()*(high-low)+low);}
  public int randVal(int low, int high){return (int)(Math.floor(ran1()*(high-low)+low+.5));}

  public static void main (String[] args)
  {
    // Prints the nextGamma() and oldNextGamma() distributions to
    // System.out for testing/comparison.
    JavaRand r = new JavaRand();
